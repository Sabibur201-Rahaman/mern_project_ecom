                ...
                <div className="container mt-2">
                  <div className="row">
                    ...
                    <div className="col-md-5 p-3">
                      ...
                      <p className="text-muted bodySmal my-1">Category:{DetailList[0]['category']['categoryName']}</p>
                      <p className="text-muted bodySmal my-1">Brand:{DetailList[0]['brand']['brandName']}</p>
                      <p className="bodySmal mb-2 mt-1">shortDes:{DetailList['0']['shortDes']}</p>
                      {
                        
                          DetailList[0]['discount']?(
                            <span className="bodyXLarge">price:<strike class="text-secondary">{DetailList[0]['price']}</strike>{DetailList[0]['discountPrice']}</span>
                      ...
                      <div className="row">
                        <div className="col-4 p-2">
                          ...
                          <select className="form-control my-2 form-select">
                            ...
                            {
                              // DetailList[0]['details']['size'].split(",").map((item,i)=>{
                        ...
                        <div className="col-4 p-2">
                          ...
                          <select className="form-control my-2 form-select">
                            ...
                            {
                              // DetailList[0]['details']['color'].split(",").map((item,i)=>{
                              //   return(<option value={item}>{item}</option>
                              //   )
                              // })
                            }
